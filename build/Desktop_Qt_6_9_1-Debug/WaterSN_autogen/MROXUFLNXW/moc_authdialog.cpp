...
#include "../../../../include/widgets/authdialog.h"
...
void AuthDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->forgotPasswordClicked(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AuthDialog::*)()>(_a, &AuthDialog::forgotPasswordClicked, 0))
            return;
    }
}
...
// SIGNAL 0
void AuthDialog::forgotPasswordClicked()
{
